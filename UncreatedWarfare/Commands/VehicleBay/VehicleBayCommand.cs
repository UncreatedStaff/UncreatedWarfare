...
public class VehicleBayCommandTranslations : PropertiesTranslationCollection
{
    ...
    public readonly Translation<string> InvalidInput = new Translation<string>("<#ff8c69><#fff>{0}</color> is not a valid vehicle.");
    ...
    public readonly Translation<VehicleAsset> SpawnRegistered = new Translation<VehicleAsset>("<#a0ad8e>Successfully registered spawn. {0} will spawn here.", arg0Fmt: new ArgumentFormat(PluralAddon.Always(), RarityColorAddon.Instance));
    
    [TranslationData("Sent after a spawner is unlinked from a vehicle type.", IsPriorityTranslation = false)]
    public readonly Translation<VehicleAsset> SpawnDeregistered = new Translation<VehicleAsset>("<#a0ad8e>Successfully deregistered {0} spawn.", arg0Fmt: RarityColorAddon.Instance);
    ...
    public readonly Translation<uint, VehicleAsset, Guid> VehicleBayCheck = new Translation<uint, VehicleAsset, Guid>("<#a0ad8e>This spawn (<#8ce4ff>{0}</color>) is registered with vehicle: {1} <#fff>({2})</color>.", arg1Fmt: RarityColorAddon.Instance, arg2Fmt: "N");
