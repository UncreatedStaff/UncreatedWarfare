...
public class WarnCommand : Command
{
    ...
    public override void Execute(CommandInteraction ctx)
    {
        ...
        else
        {
            ...
            L.Log(Localization.Translate("warn_warned_console", 0, out _, targetNames.PlayerName, tid, callerNames.PlayerName, ctx.CallerID.ToString(Data.Locale), reason!), ConsoleColor.Cyan);
