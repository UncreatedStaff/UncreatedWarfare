...
public class BuildableComponent : MonoBehaviour
{
    ...
    public void IncrementBuildPoints(UCPlayer builder)
    {
        ...
        {
            if (CollisionCoroutine(Foundation.model.position, Buildable, builder))
                Build();
            else
    ...
    public static bool CollisionCoroutine(Vector3 position, BuildableData buildable, UCPlayer? builder)
    {
    ...
    public static bool TryPlaceBuildable(Barricade foundation, BuildableData buildable, UCPlayer placer, Vector3 point)
    {
        ...
        else
        {
            ...
            {
                if (!CollisionCoroutine(point, buildable, placer))
                {
                    return false;
                }    
            }
