    ...
    public class Invasion : CTFBaseMode<InvasionLeaderboard, BaseCTFStats, InvasionTracker>, IAttackDefense
    {
        ...
        public override void StartNextGame(bool onLoad = false)
        {
            ...
            if (_attackTeam == 1)
                ...
                SpawnBlockerOnT2();
            if (firstFlag != null)
                _vcp = FOBManager.RegisterNewSpecialFOB(Config.Invasion.SpecialFOBName, firstFlag.ZoneData.Center3D + Vector3.up, _defenseTeam, UCWarfare.GetColorHex("invasion_special_fob"), true);
