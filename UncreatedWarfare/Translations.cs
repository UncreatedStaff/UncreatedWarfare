...
partial class JSONMethods
{
    public static void CreateDefaultTranslations()
    {
        ...
        {
            { Translation.Common.NOT_IMPLEMENTED,        "<color=#ff8c69>This command hasn't been implemented yet.</color>" },
            { Translation.Common.CORRECT_USAGE,          "<color=#ff8c69>Correct usage: {0}</color>" },
            { Translation.Common.CONSOLE_ONLY,           "<color=#ff8c69>This command can not be called from console.</color>" },
            { Translation.Common.PLAYERS_ONLY,           "<color=#ff8c69>This command can only called from console.</color>" },
            { Translation.Common.PLAYER_NOT_FOUND,       "<color=#ff8c69>Player not found.</color>" },
            { Translation.Common.UNKNOWN_ERROR,          "<color=#ff8c69>We ran into an unknown error executing that command.</color>" },
            { Translation.Common.GAMEMODE_ERROR,         "<color=#ffa238>This command is not enabled in this gamemode.</color>" },
            { Translation.Common.NO_PERMISSIONS,         "<color=#ff8c69>You do not have permission to use this command.</color>" },
            { Translation.Common.NOT_ENABLED,            "<color=#ff8c69>This feature is not currently enabled.</color>" },
            { Translation.Common.NO_PERMISSIONS_ON_DUTY, "<color=#ff8c69>You must be on duty to execute that command.</color>" },
