    ...
    partial class JSONMethods
    {
        public static void CreateDefaultTranslations()
        {
            DefaultTranslations = new Dictionary<string, string>
            {
                ...
                { "request_vehicle_e_flag_delay_2+", "<color=#b3ab9f>Capture <color=#94cfff>{0} flags</color> to request this vehicle.</color>" },
                ...
                { "vbs_state_delay_caches_def_1", "Discover {0}" },
                ...
                { "vbs_state_delay_caches_def_2+", "Discover {0} more caches" },
