    ...
    partial class JSONMethods
    {
        public static void CreateDefaultTranslations()
        {
            DefaultTranslations = new Dictionary<string, string>
            {
                ...
                { "build_error_too_many_fobs", "<color=#ffab87>There can not be more than 10 fobs at a time.</color>" },
                ...
                { "ammo_vehicle_not_near_ammo_crate", "<color=#b3a6a2>Your vehicle must be next to an Ammo Crate in order to rearm.</color>" },
                ...
                { "ip_ban_feedback", "<color=#00ffff><color=#d8addb>{0}</color> was ip-banned for <color=#9cffb3>{2}</color>.</color>" },
                { "ip_ban_feedback_noip", "<color=#00ffff><color=#d8addb>{0}</color> was banned for <color=#9cffb3>{2}</color>, but their IP couldn't be found.</color>" },
