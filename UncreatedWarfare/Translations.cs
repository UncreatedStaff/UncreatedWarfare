    ...
    partial class JSONMethods
    {
        ...
        public static void CreateDefaultTranslations()
        {
            DefaultTranslations = new Dictionary<string, string>
            {
                ...
                { "whitelist_notwhitelisted", "<color=#ff8c69>The item is not allowed to be picked up.</color>" },
                { "whitelist_notallowed", "<color=#ff8c69>Your kit does not allow you to have this item.</color>" },
                { "whitelist_maxamount", "<color=#ff8c69>Your kit does not allow you to have any more of this item.</color>" },
