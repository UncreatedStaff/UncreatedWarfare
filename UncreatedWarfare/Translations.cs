...
namespace Uncreated.Warfare
{
    partial class JSONMethods
    {
        ...
        public static readonly List<ColorData> DefaultColors = new List<ColorData>
        {
            ...
            new ColorData("no_bunker_fob_color", "696969"),
            new ColorData("enemy_nearby_fob_color", "ff8754"),
            new ColorData("bleeding_fob_color", "d45555"),
            new ColorData("invasion_special_fob", "5482ff"),
            new ColorData("insurgency_cache_undiscovered_color", "b780d9"),
            new ColorData("insurgency_cache_discovered_color", "696ed1"),
