...
public class AudioRecordManager
{
    ...
    {
        if (UCWarfare.Config.AudioRecordBaseUri == null
            || UCWarfare.Config.AudioRecordUsername == null
            || UCWarfare.Config.AudioRecordPassword == null)
        {
            return;
        }

        string username = Uri.EscapeDataString(UCWarfare.Config.AudioRecordUsername);
        string password = Uri.EscapeDataString(UCWarfare.Config.AudioRecordPassword);
        _authenticateUri = new Uri(UCWarfare.Config.AudioRecordBaseUri, $"authentication?username={username}&key={password}");
        _decodeUri = new Uri(UCWarfare.Config.AudioRecordBaseUri, "decoder/form");
    }
