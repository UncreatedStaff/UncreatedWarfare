...
public class ReviveManager : BaseSingleton, IPlayerConnectListener, IDeclareWinListener
{
    ...
    internal void OnPlayerHealed(UCPlayer medic, UCPlayer target)
    {
        ...
        {
            ActionLogger.Add(ActionLogType.REVIVED_PLAYER, target.Steam64.ToString(Data.AdminLocale), medic.Steam64);
            r.RevivePlayer(null);
    ...
    internal void InjurePlayer(in DamagePlayerParameters parameters, SteamPlayer? killer)
    {
        ...
        ActionLogger.Add(ActionLogType.INJURED, "by " + (killer == null ? "self" : killer.playerID.steamID.m_SteamID.ToString(Data.AdminLocale)), parameters.player.channel.owner.playerID.steamID.m_SteamID);
