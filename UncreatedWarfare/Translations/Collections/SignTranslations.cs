...
public class SignTranslations : PropertiesTranslationCollection
{
    ...
    public readonly SignTranslation SignRules = new SignTranslation("rules", "Rules\nNo suicide vehicles.\netc.");
    ...
    public readonly SignTranslation SignBundleMisc = new SignTranslation("bundle_misc", "<#fff>Misc.");
    ...
    public readonly SignTranslation SignBundleMilitia = new SignTranslation("bundle_militia", "<#fff>Militia Bundle");

    public readonly SignTranslation SignBundleRussia = new SignTranslation("bundle_ru", "<#fff>Russia Bundle");

    public readonly SignTranslation SignBundleSoviet = new SignTranslation("bundle_soviet", "<#fff>Soviet Bundle");
    ...
    public readonly SignTranslation SignAirSoloingWarning = new SignTranslation("air_solo_warning", "<color=#f01f1c><b>Do not exit main without another <#cedcde>PILOT</color> for the Jet or Attack Heli\n\n\n<color=#ff6600>YOU WILL BE BANNED FOR 6 DAYS WITHOUT WARNING!<b></color>");
    ...
    public readonly SignTranslation SignWaitingWarning = new SignTranslation("waiting_warning", "<color=#f01f1c>Waiting for vehicles to spawn when the server is full for more than 2 minutes will result in a KICK or BAN</color>");

    [TranslationData("Change notice about waiting for vehicles while the server is full (part 1).")]
    public readonly SignTranslation SignWaitingNoticePart1 = new SignTranslation("waiting_notice_1", "<color=yellow>Warning:</color>\n<color=white>Due to players sitting at base waiting for air assets, we've decided that if the server capacity is full and air assets aren't available for</color>");

    [TranslationData("Change notice about waiting for vehicles while the server is full (part 2).")]
    public readonly SignTranslation SignWaitingNoticePart2 = new SignTranslation("waiting_notice_2", "<color=white>a considerable amount of time, we reserve the right to warn you not to. If you continue to sit around we will kick you to allow another player in the queue to play.</color>");

    [TranslationData("Notice about soloing (part 1).")]
    public readonly SignTranslation SignSoloNoticePart1 = new SignTranslation("solo_notice_1", "<color=#f01f1c>You are not allowed to take out the following vehicles without a passenger:</color>");

    [TranslationData("Notice about soloing (part 2, team 1).")]
    public readonly SignTranslation SignSoloNoticePart2T1 = new SignTranslation("solo_notice_2_t1", "<#f01f1c>- Abrams\n- LAV\n- Stryker\n- Attack Heli\n- Fighter Jet\n</color>\n<#ec8100>You will get banned for <#ff6600>3 days</color> if you do!</color>\n<#f01f1c>If your passenger leaves, return to base (RTB).</color>");

    [TranslationData("Notice about soloing (part 2, team 2).")]
    public readonly SignTranslation SignSoloNoticePart2T2 = new SignTranslation("solo_notice_2_t2", "<#f01f1c>- T-90\n- BTR-82A\n- BDRM\n- BMP-2\n- Attack Heli\n- Fighter Jet\n</color>\n<#ec8100>You will get banned for <#ff6600>3 days</color> if you do!</color>\n<#f01f1c>If your passenger leaves, return to base (RTB).</color>");
    ...
    public readonly SignTranslation SignTutorialGetKitPart1 = new SignTranslation("tutorial_get_kit_1", "<#ff6600><b>How do I get a kit?</b>");

    [TranslationData("Tells the player about kits and how to request them (part 2).")]
    public readonly SignTranslation SignTutorialGetKitPart2 = new SignTranslation("tutorial_get_kit_2", "<#cEcEcE>Look at kit sign and type <#2df332>/req</color> in chat to recieve the kit.");

    [TranslationData("Tells the player about kits and how to request them (part 3).")]
    public readonly SignTranslation SignTutorialGetKitPart3 = new SignTranslation("tutorial_get_kit_3", "<#cEcEcE>Some kits are unlocked using <#b8ffc1>credits</color>. Look at the sign and do <#2df332>/buy</color> to unlock the kit.");

    [TranslationData("Tells the player about vehicles and how to request them (part 1).")]
    public readonly SignTranslation SignTutorialGetVehiclePart1 = new SignTranslation("tutorial_get_vehicle_1", "<#ff6600><b>How do I get a vehicle?</b>");

    [TranslationData("Tells the player about vehicles and how to request them (part 2).")]
    public readonly SignTranslation SignTutorialGetVehiclePart2 = new SignTranslation("tutorial_get_vehicle_2", "<#cEcEcE>Look at the vehicle you'd like to request and type in chat <#2df332>/req</color> to unlock the vehicle.");

    [TranslationData("Tells the player about vehicles and how to request them (part 3).")]
    public readonly SignTranslation SignTutorialGetVehiclePart3 = new SignTranslation("tutorial_get_vehicle_3", "<#cEcEcE>Some vehicles require a special kit. Request a <#cedcde>CREWMAN</color> or <#cedcde>PILOT</color> kit to gain acces to them!");

    [TranslationData("Header for the FAQ (frequently asked questions) section of the tutorial.")]
    public readonly SignTranslation SignTutorialFAQHeader = new SignTranslation("tutorial_faq_header", "<#ff6600><b>FAQ</b>");

    [TranslationData("(question) This FAQ explains how to Give Up after being injured.")]
    public readonly SignTranslation SignTutorialFAQGiveUpQ = new SignTranslation("tutorial_faq_give_up_q", "<#2df332>Q: Help! I can't reset when downed!");

    [TranslationData("(answer) This FAQ explains how to Give Up after being injured.")]
    public readonly SignTranslation SignTutorialFAQGiveUpA = new SignTranslation("tutorial_faq_give_up_a", "<#cEcEcE>A: Press the '/' button on your keyboard to give up when injured. If this doesn't work, Head to your <#2df332>keybind settings</color> and set <#f32d2d>Code Hotkey #3</color> to your preference!");
    ...
    public readonly SignTranslation SignSaddamHussein = new SignTranslation("saddam_hussein", "<color=red>Saddam Hussein\n ▇▅▆▇▆▅▅█</color>");

    [TranslationData("Points to the building with elite kits.")]
    public readonly SignTranslation SignEliteKitPointer = new SignTranslation("elite_kit_pointer", "<color=#f0a31c>Elite kits found in this building     --></color>");


    public readonly SignTranslation SignFAQ1Part1 = new SignTranslation("faq1_1", """
                                                                                  <#fa6122>Giving up or Flaring
                                                                                  """);

    public readonly SignTranslation SignFAQ1Part2 = new SignTranslation("faq1_2", """
                                                                                  <#2df332>Q: Help! I can't give up when I'm downed or flare in a air vehicle </color>
                                                                                  """);

    public readonly SignTranslation SignFAQ1Part3 = new SignTranslation("faq1_3", """
    ...
    public readonly SignTranslation SignFAQ2Part1 = new SignTranslation("faq2_1", """
                                                                                  <#fa6122>Squad Commands
                                                                                  """);

    public readonly SignTranslation SignFAQ2Part2 = new SignTranslation("faq2_2", """
    ...
    public readonly SignTranslation SignFAQ2Part3 = new SignTranslation("faq2_3", """
    ...
    public readonly SignTranslation SignFAQ3Part1 = new SignTranslation("faq3_1", """
                                                                                  <#fa6122>How do I get a kit?
                                                                                  """);

    public readonly SignTranslation SignFAQ3Part2 = new SignTranslation("faq3_2", """
                                                                                   <#FFFFFF>If you are new to the server look at a kit sign that says free, and type <#2df332>/request</color> to receive it
                                                                                   """);

    public readonly SignTranslation SignFAQ3Part3 = new SignTranslation("faq3_3", """
    ...
    public readonly SignTranslation SignFAQ4Part1 = new SignTranslation("faq4_1", """
                                                                                  <#fa6122>How do I deploy to the battlefield?
                                                                                  """);

    public readonly SignTranslation SignFAQ4Part2 = new SignTranslation("faq4_2", """
    ...
    public readonly SignTranslation SignFAQ4Part3 = new SignTranslation("faq4_3", """
                                                                                  <#FFFFFF>To deploy you have to type: /dep fob(number) <#2df332>e.g. /deploy fob1</color> Check its location before deploying.
                                                                                  """);

    public readonly SignTranslation SignFAQ5Part1 = new SignTranslation("faq5_1", """
                                                                                  <#fa6122>How do I get a vehicle?
                                                                                  """);

    public readonly SignTranslation SignFAQ5Part2 = new SignTranslation("faq5_2", """
                                                                                  <#FFFFFF>Look at a vehicle you would like to request, and type <#2df332>/request</color> to unlock the vehicle
                                                                                  """);

    public readonly SignTranslation SignFAQ5Part3 = new SignTranslation("faq5_3", """
