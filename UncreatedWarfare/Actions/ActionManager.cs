...
namespace Uncreated.Warfare.Actions
{
    public class ActionManager : BaseSingleton
    {
        ...
        public static void NeedMedic(UnturnedButton button, Player player)
        {
            ...
            var action = new Action(caller, Gamemode.Config.UI.ActionNeedMedic.Value, Gamemode.Config.UI.ActionNearbyMedic.Value, viewers, updateFrequency: 0.5f, lifeTime: 10, EActionOrigin.FOLLOW_CALLER, T.NeedMedicChat, T.NeedMedicToast);
            action.Start();
            CloseUI(caller);
        }
        ...
        public static void NeedAmmo(UnturnedButton button, Player player)
        {
            ...
            var action = new Action(caller, Gamemode.Config.UI.ActionNeedAmmo.Value, Gamemode.Config.UI.ActionNearbyAmmo.Value, viewers, updateFrequency: 0.5f, lifeTime: 10, EActionOrigin.FOLLOW_CALLER, T.NeedAmmoChat, T.NeedAmmoToast);
            action.Start();
            CloseUI(caller);
        }
        ...
        public static void NeedRide(UnturnedButton button, Player player)
        {
            ...
            var action = new Action(caller, Gamemode.Config.UI.ActionNeedRide.Value, null, viewers, updateFrequency: 0.5f, lifeTime: 10, EActionOrigin.FOLLOW_CALLER, T.NeedRideChat, T.NeedRideToast);
        ...
        public static void NeedSupport(UnturnedButton button, Player player)
        {
            ...
            var action = new Action(caller, Gamemode.Config.UI.ActionNeedSupport.Value, null, viewers, updateFrequency: 0.5f, lifeTime: 10, EActionOrigin.FOLLOW_CALLER, T.NeedSupportChat, T.NeedSupportToast);
            action.Start();
            CloseUI(caller);
        }
        ...
        public static void HeliPickup(UnturnedButton button, Player player) // WIP
        {
            ...
            var action = new Action(caller, Gamemode.Config.UI.ActionHeliPickup.Value, null, viewers, toastReceivers, updateFrequency: 1, lifeTime: 120, EActionOrigin.CALLER_POSITION, T.HeliPickupChat, T.HeliPickupToast, squadWide: true);
            action.CheckValid = () =>
            {
        ...
        public static void HeliDropoff(UnturnedButton button, Player player) // WIP
        {
            ...
            var action = new Action(caller, Gamemode.Config.UI.ActionHeliDropoff.Value, null, viewers, toastReceivers, updateFrequency: 1, lifeTime: 150, EActionOrigin.CALLER_MARKER, T.HeliDropoffChat, T.HeliDropoffToast, squadWide: true);
            action.CheckValid = () =>
            {
        ...
        public static void SuppliesBuild(UnturnedButton button, Player player) // WIP
        {
            ...
            var action = new Action(caller, Gamemode.Config.UI.ActionSuppliesBuild.Value, null, viewers, toastReceivers, updateFrequency: 1, lifeTime: 150, EActionOrigin.CALLER_POSITION, T.SuppliesBuildChat, T.SuppliesBuildToast, squadWide: true);
            action.CheckValid = () =>
            {
                if (F.IsInMain(caller))
                {
        ...
        public static void SuppliesAmmo(UnturnedButton button, Player player) // WIP
        {
            ...
            var action = new Action(caller, Gamemode.Config.UI.ActionSuppliesAmmo.Value, null, viewers, toastReceivers, updateFrequency: 1, lifeTime: 120, EActionOrigin.CALLER_POSITION, T.SuppliesAmmoChat, T.SuppliesAmmoToast, squadWide: true);
            action.CheckValid = () =>
            {
                if (F.IsInMain(caller))
                {
        ...
        public static void AirSupport(UnturnedButton button, Player player) // WIP
        {
            ...
            var action = new Action(caller, Gamemode.Config.UI.ActionSuppliesAmmo.Value, null, viewers, toastReceivers, updateFrequency: 1, lifeTime: 120, EActionOrigin.CALLER_LOOK, T.AirSupportChat, T.AirSupportToast, squadWide: true);
            action.CheckValid = () =>
            {
                if (F.IsInMain(caller))
                {
        ...
        public static void ArmorSupport(UnturnedButton button, Player player) // WIP
        {
            ...
            var action = new Action(caller, Gamemode.Config.UI.ActionSuppliesAmmo.Value, null, viewers, toastReceivers, updateFrequency: 1, lifeTime: 120, EActionOrigin.CALLER_LOOK, T.ArmorSupportChat, T.ArmorSupportToast, squadWide: true);
            action.CheckValid = () =>
            {
                if (F.IsInMain(caller))
                {
        ...
        private static void TryUnloadSupplies(UCPlayer caller, int amount, JsonAssetReference<ItemAsset>? buildOrAmmo)
        {
            ...
            var vehicle = caller.CurrentVehicle;
