...
public class Vector4TypeConverter : TypeConverter
{
    ...
    public override bool IsValid(ITypeDescriptorContext context, object value)
    {
        if (value is string str)
            return TryParseVector4(str, out _, false);
    ...
    public override object? ConvertTo(ITypeDescriptorContext context, CultureInfo culture, object value, Type destinationType)
    {
        ...
        string Fallback(in Vector4 val)
        {
    ...
    public override object? ConvertFrom(ITypeDescriptorContext context, CultureInfo culture, object? value)
    {
        ...
        if (!TryParseVector4(str, out object? v4, true))
        {
    ...
    private static bool TryParseVector4(string str, [MaybeNullWhen(false)] out object obj, bool create)
    {
        obj = null;
        ...
        obj = create ? new Vector4(x, y, z, w) : null!;
        return true;
    }
}