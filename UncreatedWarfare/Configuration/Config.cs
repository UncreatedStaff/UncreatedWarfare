...
public class SystemConfigData : JSONConfigData
{
    ...
    public ModerationConfiguration ModerationSettings { get; set; }

    [JsonPropertyName("homebase")]
    public HomebaseConfiguration? HomebaseConfig { get; set; }

    [JsonPropertyName("audioRecording")]
    public AudioRecordConfiguration? AudioRecordConfig { get; set; }
    ...
    {
        ModerationSettings = new ModerationConfiguration();
        ...
        StripeAPIKey = null;
        WebsiteDomain = null;
        AudioRecordConfig = new AudioRecordConfiguration
        {
            VoiceBufferSize = 1048576 // 1 MiB
        };
    }
    public class HomebaseConfiguration
    {
        [JsonPropertyName("enabled")]
        public bool Enabled { get; set; }

        [JsonPropertyName("homebaseGetJwtEndpoint")]
        public string? AuthEndpoint { get; set; }

        [JsonPropertyName("homebaseAuthKey")]
        public string? AuthKey { get; set; }

        [JsonPropertyName("homebaseConnectEndpoint")]
