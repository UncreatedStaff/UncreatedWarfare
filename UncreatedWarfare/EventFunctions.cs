...
public static class EventFunctions
{
    /*private void SubscribeToEvents()
       {
           ...
           WarfarePlayerLocale.OnLocaleUpdated += EventFunctions.OnLocaleUpdated;
    ...
    internal static void OnStructurePlaced(StructureRegion region, StructureDrop drop)
    {
        ...
        ActionLog.Add(ActionLogType.PlaceStructure, $"{drop.asset.itemName} / {drop.asset.id} / {drop.asset.GUID:N} - Team: {data.group}, ID: {drop.instanceID}", data.owner);
    }
    internal static void OnBarricadePlaced(BarricadeRegion region, BarricadeDrop drop)
    {
        ...
        ActionLog.Add(ActionLogType.PlaceBarricade, $"{drop.asset.itemName} / {drop.asset.id} / {drop.asset.GUID:N} - Team: {data.group}, ID: {drop.instanceID}", data.owner);
    }
    ...
    // 
    // 
    //         WarfarePlayer? firer = WarfarePlayer.FromPlayer(gun.player);
    //         if (firer is null)
    //             return;
    // 
    ...
    //     }
    // 
    //     WarfarePlayer? instigator = WarfarePlayer.FromCSteamID(instigatorSteamID);
    // 
    ...
    //         instigatorSteamID.TryGetPlayerData(out WarfarePlayerData? instigatorData);
    //         switch (damageOrigin)
    //         {
    ...
    //                         if (pl.Player.TryGetPlayerData(out WarfarePlayerData d) && d.TriggeringLandmine != null &&
    ...
    //                         {
    //                             WarfarePlayer pl = PlayerManager.OnlinePlayers[i];
    //                             if (pl.Player.TryGetPlayerData(out WarfarePlayerData d) && d.TriggeringLandmine == drop)
    //                             {
    //                                 triggerer = pl;
    //                                 break;
    //                             }
    ...
    //         WarfarePlayer ucplayer = e.Player;
    //         ucplayer.Loading = true;
    //         bool shouldApplyLastKit = false, forceLastKitRemoval = false;
    // 
    //         if (WarfarePlayer.LoadingUI.HasAssetOrId)
    //             WarfarePlayer.LoadingUI.SendToPlayer(ucplayer.Connection, T.LoadingOnJoin.Translate(ucplayer));
    // 
    ...
    //         WarfarePlayerData pt = ucplayer.Player.transform.gameObject.AddComponent<WarfarePlayerData>();
    // 
    ...
    //             if (ucplayer.IsOnline && WarfarePlayer.LoadingUI.HasAssetOrId)
    //             {
    //                 WarfarePlayer.LoadingUI.ClearFromPlayer(ucplayer.Connection);
    //             }
    ...
    //     }
    //     bool isMuted = false;
    //     WarfarePlayer? ucplayer = PlayerManager.FromID(speaker.channel.owner.playerID.steamID.m_SteamID);
    ...
    // {
    //     WarfarePlayer? player = WarfarePlayer.FromSteamPlayer(client);
    ...
    //         if (data != null || instigatingPlayer.TryGetPlayerData(out data))
    //         {
    //             WarfarePlayer? pl = WarfarePlayer.FromPlayer(instigatingPlayer);
    ...
    //             };
    //             data.LastBleedingEvent = new PlayerDied(WarfarePlayer.FromPlayer(instigatingPlayer)!)
    //             {
    ...
    //         return;
    // 
    //     WarfarePlayer? ucplayer = WarfarePlayer.FromSteamPlayer(player);
    ...
    // }
    // private static IEnumerator WaitToCloseStorage(WarfarePlayer player)
    // {
    ...
    //             if (damageOrigin == EDamageOrigin.Rocket_Explosion)
    //             {
    //                 if (pl.player.TryGetPlayerData(out WarfarePlayerData c))
    //                 {
    ...
    //             {
    //                 if (pl.player.TryGetPlayerData(out WarfarePlayerData c) && c.ExplodingLandmine != null)
    //                 {
    ...
    //         else if (damageOrigin == EDamageOrigin.Trap_Explosion)
    //         {
    //             if (pl.player.TryGetPlayerData(out WarfarePlayerData c) && c.TriggeringLandmine != null)
    //             {
    ...
    //     }
    // 
    //     WarfarePlayer? ucplayer = WarfarePlayer.FromPlayer(parameters.player);
    ...
    //     }
    // 
    //     WarfarePlayer? killer = WarfarePlayer.FromCSteamID(parameters.killer);
    // 
    //     // AMC damage multiplier application
    ...
    //         if (parameters.player.TryGetPlayerData(out WarfarePlayerData data))
    ...
    //     }
    // }
    // public static void ClearPlayerMarkerForSquad(WarfarePlayer ucplayer)
    // {
    //     if (ucplayer.LastPing != null)
    //         ClearPlayerMarkerForSquad(ucplayer, ucplayer.LastPing);
    // }
    // 
    // public static void ClearPlayerMarkerForSquad(WarfarePlayer ucplayer, EffectAsset marker)
    // {
    //     if (marker == null) return;
    //     GameThread.AssertCurrent();
    //     if (ucplayer.Squad == null)
    ...
    //             L.LogError(ex);
    //         }
    //         WarfarePlayerData? c = ucplayer.Player.GetPlayerData(out bool gotptcomp);
    //         if (UCWarfare.Config.EnablePlayerJoinLeaveMessages)
    ...
    // {
    //     WarfarePlayer? pl = WarfarePlayer.FromPlayer(target);
    //     WarfarePlayer? pl2 = WarfarePlayer.FromPlayer(instigator);
    //     if (instigator.equipment.asset is ItemConsumeableAsset asset)
    //     {
    //         if (asset.bleedingModifier == ItemConsumeableAsset.Bleeding.Heal)
    //         {
    //             if (target.TryGetPlayerData(out WarfarePlayerData data))
    //             {
    //                 data.LastBleedingArgs = default;
    //                 data.LastBleedingEvent = null;
    //             }
    ...
    //                 data.LastBleedingEvent = new PlayerDied(WarfarePlayer.FromPlayer(target)!)
    //                 {
    //                     Cause = EDeathCause.INFECTION,
    //                     DeadTeam = data.LastBleedingArgs.DeadPlayerTeam,
    //                     Instigator = instigator.channel.owner.playerID.steamID,
    //                     Killer = WarfarePlayer.FromPlayer(instigator),
    ...
    //         return;
    // 
    //     if (WarfarePlayer.FromPlayer(equipment.player) is { } player && player.OnDuty())
    //         return;
    // 
    //     shouldallow = false;
    // }
