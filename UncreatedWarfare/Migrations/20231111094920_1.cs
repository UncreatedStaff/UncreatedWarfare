        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_faction_translations_lang_info_LanguageId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    pk = table.Column<uint>(nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    LanguageKey = table.Column<uint>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Steam64 = table.Column<ulong>(nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    LanguageKey = table.Column<uint>(nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_faction_translations_LanguageId",
                table: "faction_translations",
                column: "LanguageId");
