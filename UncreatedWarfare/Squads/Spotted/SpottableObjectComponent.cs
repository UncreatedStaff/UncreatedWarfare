...
public class SpottableObjectComponent : MonoBehaviour, IManualOnDestroy
{
    ...
    [
        ...
        new SpotterTypeStats(SpottedType.LightVehicle, VehicleType.Humvee,          120f,  0.5f, "Effects:Spotted:Humvee",        Vector3.zero),
        new SpotterTypeStats(SpottedType.LightVehicle, VehicleType.TransportGround, 120f,  0.5f, "Effects:Spotted:Truck",         Vector3.zero),
        new SpotterTypeStats(SpottedType.LightVehicle, VehicleType.ScoutCar,        120f,  0.5f, "Effects:Spotted:ScoutCar",      Vector3.zero),
        new SpotterTypeStats(SpottedType.LightVehicle, VehicleType.LogisticsGround, 120f,  0.5f, "Effects:Spotted:Truck",         Vector3.zero),
        new SpotterTypeStats(SpottedType.Armor,        VehicleType.APC,             120f,  0.5f, "Effects:Spotted:APC",           Vector3.zero),
        new SpotterTypeStats(SpottedType.Armor,        VehicleType.IFV,             120f,  0.5f, "Effects:Spotted:IFV",           Vector3.zero),
        new SpotterTypeStats(SpottedType.Armor,        VehicleType.MBT,             120f,  0.5f, "Effects:Spotted:MBT",           Vector3.zero),
        new SpotterTypeStats(SpottedType.Aircraft,     VehicleType.TransportHeli,   120f,  0.5f, "Effects:Spotted:TransportHeli", Vector3.zero),
        new SpotterTypeStats(SpottedType.Aircraft,     VehicleType.AttackHeli,      120f,  0.5f, "Effects:Spotted:AttackHeli",    Vector3.zero),
        new SpotterTypeStats(SpottedType.Aircraft,     VehicleType.Jet,             120f,  0.5f, "Effects:Spotted:Jet",           Vector3.zero),
        ...
        // other
        new SpotterTypeStats(SpottedType.Infantry,     VehicleType.None,            60f,  0.5f, "Effects:Spotted:Infantry",      new Vector3(0f, 1.5f, 0f)),
